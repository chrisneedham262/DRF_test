...
class APIBasicTests(TestsMixin, TestCase):
    ...
    def test_login_failed_email_validation(self):
        ...
        self.assertEqual(resp.json['non_field_errors']
                         [0], u'Must include "email" and "password".')
    ...
    def test_login_failed_username_validation(self):
        ...
        self.assertEqual(resp.json['non_field_errors'][0],
                         u'Must include "username" and "password".')
    ...
    def test_login_failed_username_email_validation(self):
        ...
        resp = self.post(self.login_url, data=payload, status_code=400)
        self.assertEqual(resp.json['non_field_errors'][0],
                         u'Must include either "username" or "email" and "password".')
    ...
    def test_registration(self):
        ...
        result = self.post(self.register_url,
                           data=self.REGISTRATION_DATA, status_code=201)
